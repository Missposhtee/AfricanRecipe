...
namespace AfricanRecipe.WebMvc.Controllers
{
    ...
    public class AfricanRecipeController : Controller
    {
        ...
        private IAfricanRecipeService africanRecipeService => _africanRecipeService.Value;
        public AfricanRecipeController()
        {
            _africanRecipeService = new Lazy<IAfricanRecipeService>(() => new AfricanRecipeService(Guid.Parse(User.Identity.GetUserId())));
        ...
        private AfricanRecipeService AfricanRecipeService()
        {
